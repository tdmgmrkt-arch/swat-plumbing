...
const missions = [
  {
    ...
    outcomes: ["24/7 dispatch.", "Under 60-min arrival."],
    checklist: ["Burst pipes", "Sewer backups", "Slab leaks"],
    primary: true,
    image: "/emergency2.jpeg",
  },
  {
    number: "02",
    ...
    outcomes: ["Non-invasive diagnostics.", "Rapid isolation."],
    checklist: ["Slab leak location", "Pinhole leaks", "Hidden line breaks"],
    image: "/leakdetection2.jpeg",
  },
  {
    number: "03",
    unit: "Install Unit",
    ...
    title: "Water Heaters",
    href: "/water-heater",
    outcomes: ["Same-day service.", "All major brands stocked."],
    checklist: ["Tankless installation", "Tank installation", "Repair & replacement"],
    image: "/waterheater2.jpeg",
  },
  {
    number: "04",
    unit: "Treatment Unit",
    ...
    title: "Water Quality",
    href: "/water-quality",
    outcomes: ["Whole-home filtration.", "Free water testing."],
    checklist: ["Water softeners", "Filtration systems", "Reverse osmosis"],
    image: "/waterquality2.jpeg",
  },
] as const
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="mb-12 lg:mb-16 max-w-3xl">
          ...
          <p className="mt-5 text-gray-500 text-base sm:text-lg leading-relaxed">
            Emergency response, diagnostics, installation, and treatment —
            one team, one standard, zero guesswork.
          </p>
        </div>
              ...
              <Link
                ...
                className={cn(
                  ...
                  "primary" in m && m.primary
                    ? "bg-[#13181c] border-red-600/35 hover:border-red-500/60 shadow-[0_0_0_1px_rgba(220,38,38,0.08)]"
                    : "bg-[#0e1012] border-white/8 hover:border-red-600/40"
                )}
              >
                ...
                <div
                  className={cn(
                    ...
                    "primary" in m && m.primary
                      ? "bg-linear-to-t from-[#13181c] from-25% via-[#13181c]/60 via-65% to-transparent"
                      : "bg-linear-to-t from-[#0e1012] from-25% via-[#0e1012]/60 via-65% to-transparent"
                  )}
                  aria-hidden="true"
                />
        ...
        <div className="mt-16 lg:mt-20">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <Link
              href="/plumbing"
              className="group inline-flex items-center gap-2.5 text-base font-bold tracking-wide uppercase text-white bg-gray-950 hover:bg-red-600 border border-gray-950 hover:border-red-600 rounded-sm px-8 py-4 transition-colors min-h-12"
            >
