...
> = {
  ...
  "water-quality": {
    quote:
      "The best plumbing experience I've ever had — so quick and easy. Tech was professional, explained exactly what was wrong, and gave me a written estimate before he touched a thing. That's how it should be.",
    author: "K. Williams",
    location: "Aledo, TX",
  },
}
...
type Props = {
  /** Category name shown in the heading, e.g. "Plumbing Services". */
  categoryName: string
  /** Category slug — selects the curated fallback quote. */
  categorySlug: "plumbing" | "water-heater" | "water-quality"
}
...
export default async function HubReviews({
  ...
  return (
    <section
      className="relative bg-[#0e1012] border-y border-white/8 py-14 lg:py-20 overflow-hidden"
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-5 lg:gap-7 items-stretch">
          ...
          {/* Featured quote */}
          <blockquote className="relative bg-[#0a0c0e] border border-white/10 rounded-sm p-6 lg:p-7 flex flex-col gap-4">
            <div
