      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        <div className="max-w-3xl mb-12">
          ...
          <p className="text-white/55 text-base leading-relaxed">
            Every dispatch is fully equipped. Here&rsquo;s what we cover under{" "}
            {cfg.name}.
          </p>
        </div>
        ...
        >
          {cfg.scopeBullets.map((item) => (
            <li
              key={item}
              className="group flex items-start gap-3.5 bg-[#0e1012] hover:bg-[#13181c] border border-white/10 hover:border-red-600/30 rounded-sm px-5 py-4 transition-colors"
            >
