...
// or env vars are missing. Voiced to match the SWAT brand standard.
const FALLBACK_QUOTES = [
  {
    quote:
      "Showed up in 45 minutes at 11pm and stopped the leak immediately. Honest pricing, no overtime markup, no nonsense.",
    author: "M. Garcia",
  ...
  {
    quote:
      "The best plumbing experience I've ever had — so quick and easy. In and out, brand-new garbage disposal, 20 minutes.",
    author: "K. Williams",
    location: "Aledo, TX",
    rating: 5,
  },
  {
    quote:
      "Tech was professional, explained exactly what was wrong, and gave me a written estimate before he touched a thing. That's how it should be.",
    author: "R. Patel",
...
export default async function ServiceReviews({ cfg }: { cfg: ServiceConfig }) {
  ...
  const quotes = [
    ...liveReviews,
    ...FALLBACK_QUOTES.slice(0, 3 - liveReviews.length),
  ]
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-12">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-white/55 text-base leading-relaxed">
              S.W.A.T. Plumbing has dispatched to thousands of {cfg.name.toLowerCase()} calls across North Texas. Here&apos;s what it actually sounds like.
            </p>
          </div>
        ...
        >
          {quotes.map((q, i) => (
            <li
              key={i}
              className="relative bg-[#0a0c0e] border border-white/10 rounded-sm p-7 lg:p-8 flex flex-col"
            >
              <Quote
