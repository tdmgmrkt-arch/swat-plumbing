        ...
        >
          {services.map((svc) => (
            <li key={svc.slug}>
              <Link
                href={svc.href}
                className="group relative block bg-[#0e1012] hover:bg-[#13181c] border border-white/10 hover:border-red-600/40 rounded-sm p-7 lg:p-8 h-full transition-colors focus-visible:outline-2 focus-visible:outline-red-600"
