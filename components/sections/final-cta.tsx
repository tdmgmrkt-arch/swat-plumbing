...
export default async function FinalCta() {
  ...
  const proof = [
    ...
    { value: "<60", label: "Min Arrival", unit: "MIN" },
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-5 sm:px-6 text-center">
        ...
        >
          Need a plumber
          <br />
          <span className="text-red-500">on site fast?</span>
        </h2>

        {/* Body — tighter, operational */}
        <p className="text-white/65 text-base sm:text-lg leading-relaxed max-w-xl mx-auto mb-10">
          One call. Real dispatch. Under-60-minute arrival on emergencies —
          across {communityCount}+ North Texas communities.
        </p>
        ...
        >
          {proof.map((p) => (
            <li
              key={p.label}
              className="bg-[#0a0c0e] px-4 py-5 flex flex-col items-center gap-2"
            >
