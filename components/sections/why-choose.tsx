...
const pillars = [
  {
    ...
    bullets: ["24/7 dispatch", "Under 60-min arrival", "Emergency-ready crews"],
    primary: true,
  },
  {
    icon: DollarSign,
    title: "Upfront Pricing",
    bullets: ["Flat-rate estimates", "No surprise charges", "Approved before work starts"],
  },
  {
    icon: Award,
    title: "Mission-Ready Technicians",
    bullets: ["Texas licensed", "Background checked", "Fully equipped trucks"],
  },
  {
    icon: Sparkles,
    title: "Clean Execution",
    bullets: ["Drop cloths", "Shoe covers", "Full cleanup"],
  },
] as const
          ...
          {pillars.map((pillar) => {
            ...
            return (
              ...
              >
                ...
                {/* PRIMARY tag slot — always reserves space so icons & titles
                    align horizontally across all four pillars */}
