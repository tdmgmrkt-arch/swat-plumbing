...
/** Thin wrapper around the global FinalCta pattern, with city name interpolated
 *  into the headline and the primary hub phone leading the CTA row. */
export default function CityFinalCta({ cfg }: { cfg: CityConfig }) {
  const primaryPhone =
    cfg.primaryHubSlug === "aledo"
      ? { tel: siteConfig.phone.aled_tel, display: siteConfig.phone.aledo }
      : { tel: siteConfig.phone.fw_tel, display: siteConfig.phone.fortWorth }
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-5 sm:px-6 mb-12 lg:mb-16">
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-[#0e1012] border border-red-600/30 rounded-sm">
      ...
      <div className="relative max-w-4xl mx-auto px-5 sm:px-6 text-center">
        ...
        <p className="text-white/65 text-base sm:text-lg leading-relaxed max-w-xl mx-auto mb-10">
          One call. Real dispatch. S.W.A.T. Plumbing is in {cfg.county} County — any
          hour, any day. No call center. No relay.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            ...
            aria-label={`Call S.W.A.T. Plumbing ${cfg.name} at ${primaryPhone.display}`}
          >
