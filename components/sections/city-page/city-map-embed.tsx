    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-white/8 rounded-sm overflow-hidden border border-white/10">
          {/* Map iframe */}
          <div className="relative lg:col-span-2 bg-[#0a0c0e] min-h-80">
            <iframe
              src={embedSrc}
              title={`Map of S.W.A.T. Plumbing ${location.name} office`}
              width="100%"
              height="100%"
          ...
          {/* Address + actions */}
          <div className="bg-[#0a0c0e] p-6 lg:p-7 flex flex-col">
