      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        <div className="mb-10 max-w-2xl">
          ...
          >
            Neighborhoods we
            <br />
            <span className="text-red-500">deploy to in {cfg.name}.</span>
          </h2>
        </div>
        ...
        >
          {cfg.neighborhoods.map((hood) => (
            <li
              key={hood.name}
              className="group relative bg-[#0e1012] border border-white/10 hover:border-red-600/35 rounded-sm px-5 py-4 transition-colors"
            >
