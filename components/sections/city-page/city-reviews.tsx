 ...
 * returned, or API call failed). Voiced to match the SWAT brand
 * standard so the section never reads as empty.
 */
...
export default async function CityReviews({ cfg }: { cfg: CityConfig }) {
  ...
  return (
    <section
      className="relative bg-[#0e1012] border-y border-white/8 py-16 lg:py-24 overflow-hidden"
