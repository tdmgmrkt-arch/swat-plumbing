    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        <div className="mb-10 max-w-2xl">
          <TacticalLabel>Services in {cfg.name}</TacticalLabel>
          <AccentLine />
          <h2
          ...
          {highlights.map((h, i) => (
            <li key={h.service.href}>
              <Link
                ...
                className="group relative flex flex-col h-full bg-[#0a0c0e] border border-white/10 hover:border-red-600/40 hover:bg-[#13181c] rounded-sm p-5 lg:p-6 transition-colors"
              >
                {/* Corner marks */}
                <div
