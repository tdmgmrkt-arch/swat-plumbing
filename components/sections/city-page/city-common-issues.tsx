        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-gray-600 text-base leading-relaxed">
              Local soil, water chemistry, and housing stock create predictable failure
              patterns. Understanding what{"\u2019"}s common here lets S.W.A.T. Plumbing
              arrive with the right equipment already loaded.
            </p>
          </div>

          {/* Right: issues panel */}
          <div className="relative bg-[#0e1012] border border-white/8 rounded-sm p-7 lg:p-8">
            {/* Command stripe */}
