...
export function ContactForm() {
  ...
  //   ?service=<category> → pre-select dropdown (one of 7 broad categories)
  ...
  if (submitState === "success") {
    return (
      <div className="bg-[#13181c] border border-white/10 rounded-sm p-8 lg:p-12 flex flex-col items-center text-center gap-5">
        ...
        <div>
          ...
          <p className="text-white/55 text-sm leading-relaxed max-w-sm mx-auto">
            We&apos;ve routed your request to dispatch — expect a call from the
            closest hub within one business hour, or immediately if you selected
            emergency.
          </p>
        </div>
      </div>
  ...
  if (submitState === "error") {
    return (
      <div className="bg-[#13181c] border border-red-600/30 rounded-sm p-8 lg:p-12 flex flex-col items-center text-center gap-5">
        <div className="flex items-center justify-center w-14 h-14 rounded-full bg-red-600/15 border border-red-600/30">
        ...
        <div>
          ...
          <p className="text-white/55 text-sm leading-relaxed max-w-sm mx-auto mb-6">
            The form couldn&apos;t send. Call either hub directly — lines are
            always live.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 border border-white/25 text-white bg-transparent hover:bg-white/8 hover:border-white/40 font-semibold text-sm tracking-wide uppercase px-6 py-3 rounded-sm min-h-[44px] transition-colors"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                  ...
                  <label
                    ...
                    className={cn(
                      ...
                      isSelected
                        ...
                        : "border-white/15 bg-[#0a0c0e] text-white/70 hover:border-white/30 hover:text-white"
                    )}
                  >
                    <input
                      type="radio"
        ...
        <div className="flex flex-col gap-1.5 lg:col-span-2">
          ...
          <textarea
            id="contact-message"
            rows={5}
            placeholder="Describe what's happening — the more detail, the faster dispatch can route the right tech."
            className={cn(
              "bg-[#0a0c0e] text-white text-base placeholder:text-white/40",
        ...
        <div className="lg:col-span-2">
          ...
          <p className="text-white/45 text-[11px] mt-3 leading-relaxed max-w-2xl">
            By submitting this form, you agree to be contacted by S.W.A.T.
            Plumbing LLC by phone, text, or email regarding your service
