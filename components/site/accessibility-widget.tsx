...
const STORAGE_KEY = "swat-a11y-settings"
  ...
  return (
    <>
      <button
        ...
        className="a11y-widget-root fixed z-[60] right-4 bottom-[88px] lg:right-6 lg:bottom-6 h-12 w-12 lg:h-14 lg:w-14 rounded-full bg-red-600 hover:bg-red-700 active:bg-red-800 text-white shadow-lg shadow-black/40 ring-2 ring-white/10 flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-red-400/60"
      >
      ...
      {open && (
        ...
        >
          ...
          <div
            ...
            className="relative h-full w-full max-w-sm bg-[#0a0c0e] text-white border-l border-white/10 shadow-2xl flex flex-col"
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-white/10 bg-[#111214]">
            ...
            <div className="px-5 py-4 border-t border-white/10 bg-[#111214]">
              <button
                type="button"
                onClick={reset}
