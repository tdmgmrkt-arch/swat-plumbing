...
export const metadata: Metadata = {
  ...
  description:
    "How S.W.A.T. Plumbing LLC collects, uses, and safeguards your personal information, including our SMS messaging policy and your privacy rights.",
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6 py-16 lg:py-24">
            ...
            <p className="text-white/65 text-base sm:text-lg leading-relaxed max-w-2xl">
              S.W.A.T. Plumbing LLC (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6 space-y-12 lg:space-y-14">
            <PolicySection
              ...
              bullets={[
                ...
                "Service address and request details",
            ...
            <PolicySection
              ...
              bullets={[
                "Provide plumbing services and respond to inquiries",
                "Schedule appointments and send service updates",
                "Communicate regarding your service requests",
            ...
            <article
              className="relative bg-[#0e1012] border border-white/12 rounded-sm overflow-hidden"
            ...
            >
              ...
              <div className="p-6 lg:p-8 pl-7 lg:pl-9">
                ...
                <p className="text-white/70 text-sm sm:text-base leading-relaxed mb-5">
                  ...
                  messages from S.W.A.T. Plumbing LLC, including appointment
                  reminders, service updates, and occasional promotional
                  messages.
                </p>
