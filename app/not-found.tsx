...
export const metadata: Metadata = {
  ...
  description:
    "The page you were looking for doesn't exist or has moved. Get back on track — or call dispatch directly for 24/7 emergency plumbing service.",
...
const quickLinks = [
  {
    ...
    desc: "Emergency, repairs, drain, sewer, gas line",
  },
  {
    href: "/water-heater",
    icon: Flame,
    title: "Water Heaters",
    desc: "Tank, tankless, installation, repair",
  },
  {
    href: "/water-quality",
    icon: Droplets,
    title: "Water Quality",
    desc: "Softeners, filtration, reverse osmosis",
  },
  {
    href: "/areas-served",
    icon: MapPin,
    title: "Areas Served",
    desc: "49 communities across North Texas",
  },
  {
    href: "/blog",
    icon: BookOpen,
    title: "Field Notes",
    desc: "Tips & guides from licensed pros",
  },
  {
    href: "/contact-us",
    icon: Phone,
    title: "Contact",
    desc: "Get a quote or schedule service",
  },
] as const
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* ============================================================== */}
        <section
          className="relative isolate bg-[#080a0c] overflow-hidden min-h-[60vh] flex items-center"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-10 lg:gap-16 items-center">
              ...
              <div className="max-w-xl">
                ...
                <p className="text-white/40 text-xs font-mono tracking-wider">
                  24/7 dispatch · Aledo + Fort Worth
                </p>
              </div>
            </div>
          </div>
        ...
        {/* ============================================================== */}
        <section
          className="relative bg-[#0e1012] border-t border-white/8 py-14 lg:py-20 overflow-hidden"
                  ...
                  <li key={link.href}>
                    <Link
                      ...
                      className={cn(
                        ...
                        "bg-[#0a0c0e] border border-white/10 hover:border-red-600/40 rounded-sm transition-colors"
                      )}
                    >
                      <div
        ...
        {/* ============================================================== */}
        <section
          className="relative bg-[#080a0c] py-12 lg:py-16 overflow-hidden"
        ...
        >
          ...
          <div className="relative max-w-5xl mx-auto px-5 sm:px-6">
            <div className="relative bg-[#0e1012] border-2 border-dashed border-red-600/50 rounded-sm p-7 lg:p-9 shadow-[0_0_0_1px_rgba(220,38,38,0.1),0_8px_30px_-12px_rgba(220,38,38,0.25)]">
              <div
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 lg:gap-10 lg:items-center">
                <div>
                  ...
                  <p className="text-white/65 text-sm sm:text-base leading-relaxed">
                    Burst pipe, slab leak, sewer backup, gas smell — the
                    dispatch line is live 24/7. A real human answers, not a
                    voicemail tree.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2 lg:min-w-[16rem]">
                  ...
                  >
                    ...
                    <span className="font-mono">{siteConfig.phone.aledo}</span>
                  </Link>
                  <Link
                  ...
                  <Link
                    href="/contact-us"
                    className="text-center text-white/50 hover:text-white text-xs font-mono tracking-wider transition-colors pt-1 inline-flex items-center justify-center gap-1.5"
                  >
