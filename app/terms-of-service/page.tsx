...
export const metadata: Metadata = {
  ...
  description:
    "Terms governing use of the S.W.A.T. Plumbing LLC website and service inquiries — including estimates, pricing, workmanship guarantee, and limitation of liability.",
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6 py-16 lg:py-24">
            ...
            <p className="text-white/65 text-base sm:text-lg leading-relaxed max-w-2xl">
              ...
              the S.W.A.T. Plumbing LLC website and any service inquiries you
        ...
        {/* ============================================================== */}
        <section
          className="relative bg-[#0e1012] border-y border-white/8 py-10 lg:py-12"
          aria-label="Business contact information"
        >
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
            <div className="relative bg-[#0a0c0e] border border-white/12 rounded-sm p-6 lg:p-7 overflow-hidden">
              <div
              ...
              <div className="pl-3">
                ...
                <p className="text-white/55 text-xs font-mono mb-4">
                  Texas Master Plumber License #M-39596 · Founded 2013
                </p>
        ...
        {/* TERMS SECTIONS                                                  */}
        {/* ============================================================== */}
        <section className="relative bg-[#080a0c] py-16 lg:py-20 overflow-hidden">
          <div
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6 space-y-12 lg:space-y-14">
            <TermsSection
              ...
              paragraphs={[
                "By accessing or using the S.W.A.T. Plumbing LLC website, submitting a service request, or otherwise engaging with us through the site, you agree to be bound by these Terms and our Privacy Policy.",
            ...
            <TermsSection
              icon={Building2}
              label="Section 02"
              title="About S.W.A.T. Plumbing LLC"
              paragraphs={[
                "S.W.A.T. Plumbing LLC is a Texas-licensed plumbing contractor operating under Texas Master Plumber License #M-39596, founded in 2013 and BBB-accredited since 2014. We provide residential and commercial plumbing services across Fort Worth, Aledo, and surrounding North Texas communities.",
                "All plumbing work is performed by licensed, insured, and background-checked employees. We do not subcontract our service work.",
              ]}
            />
            ...
            <TermsSection
              ...
              paragraphs={[
                "Forms submitted through this website are service inquiries, not service contracts. Submitting a form does not guarantee that we will perform the requested work, nor does it create a binding agreement between you and S.W.A.T. Plumbing LLC.",
                "All written or verbal estimates provided in advance of service are non-binding until a final scope of work is confirmed on-site by a licensed plumber. Estimates may be revised once the work area is inspected, the actual condition of existing plumbing is verified, or additional issues are uncovered.",
                "A binding service agreement is created only when work is authorized in writing by the homeowner or authorized property representative and a S.W.A.T. Plumbing technician on-site.",
              ]}
            />
            ...
            <TermsSection
              ...
              paragraphs={[
                "We use upfront, flat-rate pricing presented to you in writing before work begins. Pricing is based on the scope of work agreed to on-site and does not change mid-job unless additional, previously unknown work is authorized in writing by you.",
                "Payment is due upon completion of the work unless other arrangements are made in advance. We accept major credit cards, checks, and ACH transfers. Financing options are available through our financing partner — see our financing page for details.",
            ...
            <TermsSection
              ...
              paragraphs={[
                "S.W.A.T. Plumbing LLC stands behind its work. Standard service repairs are covered by our 91-day workmanship guarantee against defects in installation or workmanship. Larger installations and replacements may carry longer warranties — terms will be provided in writing at the time of service.",
                "Our workmanship guarantee covers labor performed by S.W.A.T. Plumbing. It does not extend to manufacturer defects in fixtures or equipment (which are governed by their respective manufacturer warranties), damage caused by misuse, modification of installed work by other parties, or pre-existing conditions unrelated to the work performed.",
              ]}
            />
            ...
            <TermsSection
              ...
              paragraphs={[
                "You may cancel or reschedule a scheduled (non-emergency) appointment at no charge by contacting our office at least two (2) hours before the scheduled arrival window.",
            ...
            <TermsSection
              ...
              paragraphs={[
                "To the maximum extent permitted by Texas law, S.W.A.T. Plumbing LLC's total liability arising out of or relating to any service performed shall not exceed the amount paid by you for the specific service giving rise to the claim.",
                "We are not liable for indirect, incidental, consequential, special, or punitive damages, including lost profits, loss of use, or property damage that is not the direct result of our negligence in performing the work.",
            ...
            <TermsSection
              ...
              paragraphs={[
                "Our website may contain links to third-party websites, products, or services (including financing partners, manufacturer warranty portals, or informational resources). These links are provided for convenience only.",
            ...
            <TermsSection
              ...
              paragraphs={[
                "All content on this website \u2014 including text, photography, video, logos, graphics, page layouts, and code \u2014 is the property of S.W.A.T. Plumbing LLC or its licensors and is protected by United States and international copyright and trademark laws.",
            ...
            <TermsSection
              ...
              paragraphs={[
                ...
                "Any dispute arising out of or relating to these Terms or any service performed by S.W.A.T. Plumbing LLC shall be resolved exclusively in the state or federal courts located in Tarrant County, Texas. You consent to the personal jurisdiction and venue of those courts.",
              ]}
            />
          </div>
        </section>
        ...
        {/* ============================================================== */}
        <section
          className="relative bg-[#0e1012] border-t border-white/8 py-16 lg:py-20 overflow-hidden"
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
            <div className="relative bg-[#0a0c0e] border border-white/12 rounded-sm p-8 lg:p-10 overflow-hidden">
              <div
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-10 lg:items-center">
                <div>
                  ...
                  <p className="text-white/65 text-base leading-relaxed max-w-lg">
                    ...
                    any work performed by S.W.A.T. Plumbing LLC, please contact
                    us using the details to the right.
                  </p>
                </div>

                <div className="flex flex-col gap-3 lg:min-w-[18rem]">
                  <div className="bg-[#0e1012] border border-white/10 rounded-sm p-4">
