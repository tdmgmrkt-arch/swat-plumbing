...
export const metadata: Metadata = {
  title:
    "Plumbing Service Areas — 49 Communities | Aledo & Fort Worth, TX | S.W.A.T. Plumbing",
  description:
    "S.W.A.T. Plumbing serves 49 communities across Tarrant, Parker, Denton & Johnson counties from response hubs in Aledo and Fort Worth. 24/7 emergency coverage.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    type: "website",
    url: CANONICAL,
    title:
      "Plumbing Service Areas — 49 Communities Across North Texas | S.W.A.T. Plumbing",
    description:
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* ── 1. HERO ─────────────────────────────────────────────────────── */}
        <section
          className="relative isolate bg-[#080a0c] pt-24 pb-16 lg:pt-32 lg:pb-20 overflow-hidden"
          aria-labelledby="areas-hero-heading"
        >
          <Image
            src="/hero-images/hero-areas-served.webp"
            alt=""
            fill
            sizes="100vw"
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
            ...
            <p className="text-white/65 text-base sm:text-lg leading-relaxed max-w-xl mb-4">
              S.W.A.T. Plumbing deploys from two response hubs — Aledo and Fort Worth
              — covering the full breadth of Tarrant, Parker, Denton, and Johnson
              counties. Same crew. Same standard. Every zip code.
            </p>
        ...
        {/* ── 2. STATS STRIP ──────────────────────────────────────────────── */}
        <section
          className="relative bg-[#0a0c0e] border-y border-white/8 overflow-hidden"
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
            <div className="mb-10 max-w-2xl">
              ...
              <p className="mt-4 text-white/50 text-sm leading-relaxed">
                All 49 communities receive the same licensed crew, the same upfront pricing,
                and the same 24/7 dispatch.{" "}
            ...
            >
              {allCitiesSorted.map((city) => {
                ...
                const cls = cn(
                  ...
                  isFeatured
                    ? "bg-[#0a0c0e] border-red-600/25 hover:border-red-600/50"
                    : "bg-[#0a0c0e] border-white/8 hover:border-white/20"
                )
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
            <div className="mb-10 max-w-2xl">
              <TacticalLabel>Dispatch Locations</TacticalLabel>
              <AccentLine />
              <h2
                id="hubs-heading"
                className="text-3xl sm:text-4xl font-black text-white tracking-tight leading-tight"
              ...
              <p className="mt-4 text-white/55 text-base leading-relaxed">
                Strategically positioned in Aledo and Fort Worth to cut response time
                across the entire service area — east to west and north to south.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              {siteConfig.locations.map((loc, idx) => (
                <article
                  key={loc.name}
                  className="relative bg-[#0e1012] border border-white/10 rounded-sm overflow-hidden flex flex-col hover:border-red-600/40 transition-colors"
                >
...
function CityCard({ city, featured = false }: { city: City; featured?: boolean }) {
  ...
  const cls = cn(
    "group relative bg-[#0a0c0e] border border-white/10 rounded-sm p-5",
