...
import CityNearbyCI from "@/components/sections/city-page/city-nearby-cities"
import CityFinalCta from "@/components/sections/city-page/city-final-cta"

// ---------------------------------------------------------------------------
// Static params — only builtCities produce routes. Other 47 slugs → 404.
// ---------------------------------------------------------------------------
export async function generateStaticParams() {
  return builtCities.map((cfg) => ({ slug: cfg.slug }))
}
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* 3. Credentials strip — surfaces BBB A+ + license # outside about-us */}
        <CredentialsStrip />

        {/* 4. Local intro + entity anchor */}
        <CityLocalIntro cfg={cfg} />

        {/* 4b. Map embed — only renders for cities with a physical GBP listing */}
        ...
        {/* 9. Verified reviews — live Google + curated fallback */}
        <CityReviews cfg={cfg} />
        ...
        {/* 11. Nearby cities */}
        <CityNearbyCI cfg={cfg} nearby={nearby} />

        {/* 12. Final CTA */}
        <CityFinalCta cfg={cfg} />

        {/* Last updated — required SEO signal on every city page */}
        <div className="bg-[#050608] border-t border-white/8 py-4">
